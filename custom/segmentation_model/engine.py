...
from custom.segmentation_model import utils
from custom.segmentation_model.segmentation_coco_dataset import SegmentationCOCODataset
from custom.segmentation_model.coco_eval import CocoEvaluator
from custom.segmentation_model.models import get_model_instance_segmentation


def train_one_epoch(model, optimizer, dataloader, device, epoch, print_freq, scaler=None):
    model.train()

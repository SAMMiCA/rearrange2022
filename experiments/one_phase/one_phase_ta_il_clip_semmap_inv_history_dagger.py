...
class OnePhaseTaskAwareRearrangeILClipSemmapWithInvHistoryDaggerExperimentConfig(OnePhaseTaskAwareRearrangeILClipSemmapWithInvDaggerExperimentConfig):
    ...
    @classmethod
    def tag(cls) -> str:
        return "OnePhaseTaskAwareRearrangeILClipSemmapWithInventoryHistoryDagger"

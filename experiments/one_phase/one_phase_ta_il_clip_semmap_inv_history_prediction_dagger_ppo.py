...
class OnePhaseTaskAwareRearrangeILClipSemmapWithInvSubtasHistorySubtaskPredictionDaggerPPOExperimentConfig(OnePhaseTaskAwareRearrangeILClipSemmapWithInvDaggerExperimentConfig):
    ...
    def _training_pipeline_info(cls, **kwargs) -> Dict[str, Any]:
        ...
        return dict(
            ...
            pipeline_stages=[
                ...
                PipelineStage(
                    loss_names=["imitation_loss", "ppo_loss", "subtask_loss"],
